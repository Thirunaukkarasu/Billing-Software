...
public class PurchaseViewModel : ObservableObject, INotifyPropertyChanged
{
    ...
    //private ObservableCollection<ProductCategory> _productItemCategorySource;
    //public ObservableCollection<ProductCategory> ProductItemCategorySource
    //{
    //    get
    //    {
    ...
    //private ProductCategory _SelectedProductItemCategory;
    //public ProductCategory SelectedProductItemCategory
    //{
    //    get
    //    {
    ...
    { 
        ...
        ////ProductItemCategorySource = _commonService.GetProductCategory().Value.ToObservableCollection();
