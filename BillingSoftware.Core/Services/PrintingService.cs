...
using BillingSoftware.Domain.Constants;
...
namespace BillingSoftware.Core.Services
{
    public class PrintingService : IPrintingService
    {
        ...
        public IReadOnlyList<PrinterModel> GetPrinters(PrinterType printerTypes)
        {
            ...
            {
                var pdfPrintQueue = localQueues.SingleOrDefault(lq => lq.QueueDriver.Name == PrintConstants.PdfPrinterDriveName);
            ...
            {
                var xpsPrintQueue = localQueues.SingleOrDefault(lq => lq.QueueDriver.Name == PrintConstants.XpsPrinterDriveName);
